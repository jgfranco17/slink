...
class BinaryTree:
    """
    A Tree node has data variable and pointers to nodes to its left and right.
    """
    ...
    def __depth_of_tree(self, tree) -> int:
        ...
        """
        return 1 + max(self.__depth_of_tree(tree.left), self.__depth_of_tree(tree.right)) if tree else 0
