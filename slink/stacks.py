...
from .structexceptions import StackOverflowError, StackUnderflowError
...
class Stack:
    ...
    Pushing adds an element to the top of the stack, and popping removes
    an element from the top of a stack. The order in which elements come
    off of a stack are Last In First Out (LIFO).
    """
